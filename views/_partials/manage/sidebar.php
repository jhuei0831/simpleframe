                    ...
                    <nav class="mt-5 flex-shrink-0 h-full divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
                        ...
                        <div class="mt-6 pt-6">
                            <div class="px-2 space-y-1">
                                ...
                                <a href="<?php echo APP_ADDRESS?>manage/config.php" 
                                <?php echo (strpos(strtolower($_SERVER['PHP_SELF']), 'config') !== false)?'class="bg-cyan-800 text-white group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md"':'class="text-cyan-100 hover:text-white hover:bg-cyan-600 group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md"'?>>
                                ...
                                <a href="<?php echo APP_ADDRESS?>manage/logs" 
                                <?php echo (strpos(strtolower($_SERVER['PHP_SELF']), 'logs') !== false)?'class="bg-cyan-800 text-white group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md"':'class="text-cyan-100 hover:text-white hover:bg-cyan-600 group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md"'?>>
