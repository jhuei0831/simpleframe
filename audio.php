                    ...
                    <table class="table text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><audio src="<?=APP_SRC?>audio/female/4.wav" controls controlsList="nodownload"></td>
                                <td></td>
                            </tr>
                            <? for($i=1; $i<=3; $i++): ?>
                                <tr>
                                    <td></td>
                                    <td><audio src="<?=APP_SRC?>audio/female/<?=$i?>.mp3" controls controlsList="nodownload"></audio></td>
                                    <td>
                                        <? for($j=1;$j<=5;$j++): ?>
                            ...
                            <? endfor ?>
                                <tr>
                                    <td></td>
                                    <td><audio src="<?=APP_SRC?>audio/female/4.wav" controls controlsList="nodownload"></audio></td>
                                    <td>
                                        <? for($j=1;$j<=5;$j++): ?>
                                            <div class="form-check form-check-inline">
                            ...
                            <tr>
                                <td><b><font color="red">原始音檔</font></b></td>
                                <td><audio src="<?=APP_SRC?>audio/male/4.wav" controls controlsList="nodownload"></audio></td>
                                <td></td>
                            </tr> 
                                <? for($i=1; $i<=3; $i++): ?>
                                <tr>
                                    <td></td>
                                    <td><audio src="<?=APP_SRC?>audio/male/<?=$i?>.mp3" controls controlsList="nodownload"></audio></td>
                                    <td>
                                        <? for($j=1;$j<=5;$j++): ?>
                                            <div class="form-check form-check-inline">
