...
<body>
    <div class="bg-white min-h-screen flex flex-col lg:relative">
            ...
            <main class="flex-grow flex flex-col bg-white">
                <div class="flex-grow mx-auto max-w-7xl w-full flex flex-col px-4 sm:px-6 lg:px-8">
                    <div class="flex-shrink-0 pt-10 sm:pt-16">
                        <a href="<?php echo APP_ADDRESS ?>" class="inline-flex">
                            <span class="sr-only">Workflow</span>
                            <img class="h-12 w-auto" src="<?php echo APP_IMG ?>grapes.png" alt="<?php echo APP_NAME ?>">
                        </a>
                    </div>
                    <div class="flex-shrink-0 my-auto py-16 sm:py-32">
                        <p class="text-sm font-semibold text-indigo-600 uppercase tracking-wide"></p>
                        <h1 class="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">網站維護中</h1>
                        <p class="mt-2 text-base text-gray-500">請耐心等候，造成不便請見諒</p>
                        <div class="mt-6">
                            <a href="<?php echo APP_ADDRESS ?>" class="text-base font-medium text-indigo-600 hover:text-indigo-500">返回首頁<span aria-hidden="true"> &rarr;</span></a>
                        </div>
                    </div>
                </div>
            </main>
        ...
        <div class="hidden lg:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="absolute inset-0 h-full w-full object-cover" src="<?php echo APP_IMG ?>fix.jpg" alt="<?php echo APP_NAME ?>">
        </div>
    </div>
</body>
</html>